...
pstm.setString(2, pacotes.getDestino());

pstm.setFloat(3, pacotes.getPreço());

pstm.setString(4, pacotes.getDataIda());

pstm.setString(5, pacotes.getDataVolta());

pstm.setInt(6, pacotes.getIdPacotes());
